...
<body><!-- header-start -->
	...
	<div class="buttondiv" style="font-family: 'Jua', sans-serif;">
		<a href="updateDate.mdo?house_seq=${house.house_seq}"><input type="button" value="삭제 허가" /></a>
		<a href="cancelRemove.mdo?house_seq=${house.house_seq}"><input type="button" value="취소" /></a>
	</div>
	<div style="clear:both;"></div>
	<br><br>
