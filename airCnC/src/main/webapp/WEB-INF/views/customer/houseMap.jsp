...
<body>
		...
		<form action="getDetail.do">
				...
				<div id="divToggle" style="display: none; color: black;">
					<div class="manu1">
						...
						<div class="menu2"> 가격 -
							최소값 : <font size=2 id="slider_min_view">${pric.MINP}</font> <input
								style="width: 30%;" class="min_range" type="range" value="${pric.MINP}"
								min="${pric.MINP}" max="${pric.MAXP}" name="minPrice"></input>
							최대값 : <font size=2 id="slider_max_view">${pric.MAXP}</font> <input
								style="width: 30%;" class="max_range" type="range" value="${pric.MAXP}"
	...
	<footer class="first" id="bottom">
		<div class="second">
			...
			제1026-24호<br /> 전화번호 : 1670-6250<br /> 전자우편주소 : skatn7979@gmail.com<br />
