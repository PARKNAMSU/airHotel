    ...
    <div class="container">
      ...
      <div class="form">
        ...
        <h3 style="font-size: 50px; font-weight: bold;">어떤 편의 시설을 제공하나요?</h3>
	        ...
	        <form:checkbox id="cb1" path="house_defaultsetting" />
	    ...
	    <div class="check7">
	      <h3 style="font-size: 50px; font-weight: bold; padding-bottom: 15px;">안전 시설</h3>
	        <form:checkbox id="cb7" path="house_default_fireditecter" />
	    ...
	    <div class="check8" style="padding-bottom: 15px;">
	        <form:checkbox id="cb8" path="house_default_coditecter" />
