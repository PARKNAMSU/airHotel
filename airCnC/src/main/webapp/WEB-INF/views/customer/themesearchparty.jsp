...
<header class="logo">
      ...
      ></i
      ></span>
    <label for="fas fa-question" style="font-size: 40px;">파티룸</label>
</header>
<!-- header-end -->
...
<div class="popular_destination_area" style="text-align: center;">
    <div class="container">
        <div class="theme_image">
            <img src="${pageContext.request.contextPath}/resources/images/theme_search/theme_party1.jpg"
    ...
    <script>
        ...
        window.onload = function () {
            $.ajax({
                ...
                dataType : "json",
                data : {theme_type : "house_theme_party"},
