...
<body>
    ...
    <c:url value="/8hosthouseimg.do" var="actionUrl" />
	<form:form id="8hosthouseimg" name="hostpic" modelAttribute="house" method="GET" action="${actionUrl}" enctype = "multipart/form-data">
	<div class="container">
    ...
    <div class="hostpic1">
        ...
        <div class="filebox">
			<input type="file" class="multi" id="image" accept="image/*" maxlength="2" onchange="setThumbnail(event);" /><br>
