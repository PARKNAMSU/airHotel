...
<body>
	...
	<div class="headdiv">
		<span style="font-size:50px;">종로/3가/경복궁/통인시장</span>
		<div id="belike">
	...
	<div style="clear:both;"></div><br><br>
		<div id="introdiv">
		<p style="font-size:40px;">호스트 소개</p><br><br>
		<div id="hostname">
		...
		<div id="hostintro" style="	line-height: 23px;width:50%;float:left;"> 
			산과 숲을 좋아해서 자연속으로 거쳐를 옮긴지 2년이 가까워 옵니다. 서울에서 오랜세월 만화웹툰기획.제작자로 일하면서 살아오다가 이곳 산골로 들어와서도 여전히 관련일을 하고자 했으나 산책로와 자연에 취해 까짓것 하던일을 멈추고 고양이처럼 게으르게 살아가고 있어요. 꼭 계획했던 대로 사는것만이 행복한 삶이 아니란걸 .... 여행자처럼 설레임을 안고 오늘을 행복하게 살아가고 있어요. 산책, 영화. 음악감상, 독서 사색, 고양이와 놀기, 요리하며 즐기는 삶에 언제나 숲과 산이 함께하죠.
		</div><br><br>
		<div id="" style="float:left;width:50%;padding-top:5%;padding-left: 16%">
			<button class="btn btn-outline-danger" onclick="openMessage()">호스트에게 메세지 보내기</button>
		</div>
	</div>
	<div style="clear:both;"></div>
	<div class="infodiv">
		<div class="subinfodiv">
			<span id="title">홍길동 님의 숙소</span>
			<br><br><br><br>
			<p>최대인원 10명, 방 5개, 욕실 5개, 침대 5개</p>
			
		</div>
		<hr>
		<div class="subinfodiv">
			<span id="title">여행 테마</span><br><br><br><br>
			<h3>애완견과 함께, 유명 관광지와 가까운</h3>
			
		</div>
		<hr>
		<div class="subinfodiv">
			<span id="title">편의 시설</span><br><br><br><br>
			<p>흡연실, 와이파이, 냉장고</p>
		</div>
		<hr>
		<div class="subinfodiv">
			<span id="title">체크인 / 체크아웃 시간</span><br><br>
			<div class="check">
				<strong>체크인</strong><br><br>
				<p>2020/07/21</p><br>
				<p>11:00AM</p>
			</div>
			<div class="check" style="border: none;">
				<strong>체크아웃</strong><br><br>
				<p>2020/07/22</p><br>
				<p>04:00PM</p>
			</div>
		</div>
		<br><br><hr>
		<div class="subinfodiv">
			<span id="title">숙소 소개</span><br><br><br><br>
			<h3>안녕하세요</h3>
		</div>
		<hr>
	</div>
	<div class="buttondiv">
			<button class="btn btn-outline-danger" id="btn" onclick="openDeclaration()">호스트 신고</button>
			<button class="btn btn-outline-danger" id="btn">예약 취소</button>
	</div>
	<div style="clear:both;"></div>
	<br><br>
	<div class="reviewdiv">
		<div id="rate">
			<p style="font-size:40px">후기</p><br><br>
			<a id="star"><img alt="" src="${pageContext.request.contextPath}/resources/images/reservationhouse/star.png" class="headimg">
			4.83(24)</a><!-- 평점, 후기 개수 -->
			<br><br>
			<form action="insertComments.do" id="commentsForm">
				...
				<input type="button" onclick="openSetRate()" class="btn btn-outline-danger" value="입력" style="width:150px;height:75px">
				<input type="reset" value="취소" class="btn btn-outline-danger"style="width:150px;height:75px">
			</form>
		</div>
		<div id="commantdiv">
			...
			<div class="commantform">
				...
				<p><a style="margin-left:94%;" href="updateContent?comments_seq=${item.comments_seq}">수정</a> | <a href="updateContent?comments_seq=${item.comments_seq}">삭제</a></p>
				<br>
				<p>${item.comments_date}</p>
				<br><br>
