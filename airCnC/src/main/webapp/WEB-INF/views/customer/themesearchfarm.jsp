...
<header class="logo">
      ...
      ></i
      ></span>
    <label for="fas fa-question" style="font-size: 40px;">가족체험농장</label>
</header>
<!-- header-end -->
...
<div class="popular_destination_area" style="text-align: center;">
    <div class="container">
        <div class="theme_image">
            <img src="${pageContext.request.contextPath}/resources/images/theme_search/theme_farm2.jpg"
        ...
        <div class="btn" style="padding-top: 15px;">
            <button class="btn1" type="submit" style="float: right;">
                <a href="/cnc/indexView.do">뒤로가기</a>
            </button>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        window.onload = function () {
            $.ajax({
                ...
                dataType : "json",
                data : {theme_type : "house_theme_farm"},
