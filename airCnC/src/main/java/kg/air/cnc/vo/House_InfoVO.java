...
public class House_InfoVO {
	...
	public String toString() {
		return "House_InfoVO [house_seq=" + house_seq + ", house_maxperson=" + house_maxperson
				...
				+ ", house_checkout_time=" + house_checkout_time + ", house_location_fulladdress="
				+ house_location_fulladdress + ", house_location_detailaddress=" + house_location_detailaddress
				+ ", house_regdate=" + house_regdate + "]";
	}
