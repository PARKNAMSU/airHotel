...
public class NoticeController {
	...
	public BoardVO setEmptySawon() {
		...
		@RequestMapping(value = "/detail/{idx}.mdo")//관리자가 공지사항 목록 클릭해서 들어감.
		...
		@RequestMapping("/update.mdo")//목록 클릭해서 들어가면 있는 수정 기능
		...
		@RequestMapping("/delete.mdo")//목록 클릭해서 들어가면 있는 삭제 기능
